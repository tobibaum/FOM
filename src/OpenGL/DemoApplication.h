...
#include "../../Main/ColoredWorld.h"
#include "../../Main/SignalSlot/SignalUser.h"
...
class DemoApplication : public SignalUser
{
private:
...
//	virtual	void initPhysics() = 0;
	...
	void	setCameraTargetPosition(btVector3 target)
	{
	...
	virtual 	void renderme(int pass);
